...
Να γραφεί πρόγραμμα που διαβάζει τα ονόματα 6 ομάδων μπάσκετ και να τα αποθηκεύει σε πίκανα ΟΜΑΔΑ[6], καθώς και τα σκορ των 36 μεταξύ τους αγώνων και να τα αποθηκεύει σε πίνακα ΜΑΤΣ[36,4], ως εξής: στη στήλη 1 αποθηκεύεται ο αριθμός της γηπεδούχου ομάδας, στήλη 2 ο αριθμός της φιλοξενούμενης ομάδας, στήλη 3 το σκορ της γηπεδούχου ομάδας και στήλη 4 το σκορ της φιλοξενούμενης ομάδας. Στη συνέχεια το πρόγραμμα να υπολογίζει και να εμφανίζει:<br>
_α)_ Πίνακα ΝΙΚΗΤΗΣ[36] με τα ονόματα των νικητών σε κάθε ματς.<br>
_β)_ Πίνακα ΑΠΟΤΕΛΕΣΜΑΤΑ[6,36] για τις 6 ομάδες και τους 36 αγώνες, όπου στη θέση (i,j) θα υπάρχει η τιμή ΑΛΗΘΗΣ, αν η ομάδα με αριθμό i κέρδισε τον j αγώνα, διαφορετικά θα υπάρχει η τιμή ΨΕΥΔΗΣ.<br>
_γ)_ Το όνομα της ομάδας με το μεγαλύτερο σερί νικών (θεωρείστε ότι είναι μοναδική).<br>
_δ)_ Πίνακα ΚΑΤΑΤΑΞΗ[6] με τη βαθμολογία κάθε ομάδας (2 πόντοι για κάθε νίκη, 1 πόντος για ήττα).<br>
