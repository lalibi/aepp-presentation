...
1. Τις 10 πιο κερδοφόρες εταιρείες από Ελλάδα (ΟΝ[1000000], Χ[1000000], ΕΙΣ[1000000])
1. Τα ονόματα των μαθητών με την καλύτερη βαθμολογία (ΟΝ[28], ΒΑΘ[28]), αλφαβητικά
1. Τα ονόματα των αθλητών που ξεπέρασαν τα 7 μέτρα, με τις καλύτερες επιδόσεις πρώτες και σε περίπτωση ισοβαθμίας με τη σειρά που αγωνίστηκαν (ΟΝ[100], ΕΠΙΔ[100], ?)
