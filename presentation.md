...
Σε κάποιο άθλημα διαγωνίζονται 20 αθλητές από Ελλάδα και Κύπρο. Να γραφεί πρόγραμμα που να διαβάζει και να αποθηκεύει τη χώρα (κάνοντας έλεγχο για 'GR', 'CY') και την επίδοση των αθλητών. Στη συνέχεια να εμφανίζει τη χώρα του αθλητή με την καλύτερη είδοση, τη χώρα με τον καλύτερο μέσο όσο επιδόσεων και τη χώρα με τους περισσότερους αθλητές.
...
Να γραφεί πρόγραμμα που να διαβάζει και να αποθηκεύει σε τα ονόματα 20 μαθητών, σε πίνακα ΟΝ[20], καθώς και τις βαθμολογίες τους σε 14 μαθήματα, σε πίνακα ΒΑΘ[20,14]. Κατόπιν να υπολογίζει και να εμφανίζει:<br>
_α)_ το μέσο όσο βαθμολογιών ανά μάθημα,<br>
_β)_ το όνομα του μαθητή με τα περισσότερα άριστα "20" (θεωρείστε ότι είναι μοναδικός), και<br>
_γ)_ το ποσοστό των μαθητών με έστω και μία βα8μολογία κάτω από τη βάση.
