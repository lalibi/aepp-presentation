...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.1, σελ.15
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.2, σελ.17
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.2, σελ.19
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.3, σελ.19
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.3, σελ.21
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.4, σελ.21-22
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;1.4, σελ.25
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.1, σελ.33
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.3, σελ.34-35
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.3, σελ.35
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.3, σελ.105
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.3, σελ.115
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.3, σελ.116
]
...
--
- Όλοι οι υπόλοιποι χαρακτήρες επιτρέπονται μόνο
  - Σε σχόλια: `! Γιατί δε δουλεύει ο κώδικάς μου $#@%&`
  - Σε σταθερά χαρακτήρων: `ΓΡΑΨΕ 'Το email μου είναι test@example.com!'`
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.2, σελ.128
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.2, Σημείωση, σελ.128
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.3, σελ.128
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.3, σελ.129
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.4, σελ.130
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.3, σελ.130
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.5, σελ.131
]
...
- Έλεγχος αν ένας αριθμός είναι άρτιος ή περιττός.
  - `x MOD ? = ?`
- Τι μέρα είναι η 100 μέρα ενός χρόνου αν η πρώτη μέρα του έτους είναι Κυριακή;
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.6, σελ.131
]
...
.footnote[
  ΑΕΠΠ Παράρτημα Α, Οδηγίες Μελέτης Μαθητή (2η Έκδοση), σελ.12
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.4.1, σελ.36
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.4.1, σελ.37
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.9, σελ.133
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;7.9, σελ.135
]
...
---
- Κάθε μεταβλητή **πρέπει** να εμφανίζεται είτε ως όρισμα μιας εντολής εισόδου, π.χ. `ΔΙΑΒΑΣΕ x`, είτε στην αριστερή μεριά μιας εντολής εκχώρησης, π.χ. `x <- α + β`
  - Εξαίρεση είναι οι μεταβλητές που παίρνουν τιμή από μια `ΔΙΑΔΙΚΑΣΙΑ`.
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.4.1, σελ.116
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.4.2, σελ.116
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.4.3, σελ.119
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.7, σελ.120
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.7, σελ.121
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;6.7, σελ.122
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.4.2, σελ.38
]
...
ΑΛΛΙΩΣ_ΑΝ <συνθήκη-2> ΤΟΤΕ   ! Η συνθήκη είναι μια λογική έκφραση.
  <εντολή/ές-2>
ΑΛΛΙΩΣ_ΑΝ <συνθήκη-3> ΤΟΤΕ   ! Η συνθήκη είναι μια λογική έκφραση.
  <εντολή/ές-3>
…
ΑΛΛΙΩΣ
  <εντολή/ές-ν>
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.4.3, σελ.41
]
...
.footnote[
  ΑΕΠΠ Βιβλίο Μαθητή, &sect;2.4.3, σελ.42
]
...
- [2014 / Θέμα Α2 & A3][themata_2014] ([Λύσεις][lyseis_2014])
...
- [2010 επάν. / Θέμα Β1][themata_epan_2010] ([Λύσεις][lyseis_epan_2009])
    - Αλγόριθμος σε Διάγραμμα Ροής / `ΑΝ` & `ΟΣΟ`
- [2011 / Θέμα Β1][themata_2011] ([Λύσεις][lyseis_2011])
    - Διάγραμμα Ροής σε Αλγόριθμο / `ΟΣΟ` & `ΜΕΧΡΙΣ_ΟΤΟΥ`
- [2013 / Θέμα Β1][themata_2013] ([Λύσεις][lyseis_2013])
    - Αλγόριθμος σε Διάγραμμα Ροής / `ΑΝ` & `ΟΣΟ`
- [2013 επάν. / Θέμα Β1][themata_epan_2013] ([Λύσεις][lyseis_epan_2013])
    - Διάγραμμα Ροής σε Αλγόριθμο / `ΑΝ` & `ΟΣΟ` / `ΓΙΑ`
- [2014 / Θέμα Β2][themata_2014] ([Λύσεις][lyseis_2014])
    - Διάγραμμα Ροής σε Αλγόριθμο / `ΟΣΟ` με παγίδα (_αντιστροφή συνθήκης_)
- [2012 / Θέμα Β2][themata_2012] ([Λύσεις][lyseis_2012])
    - Διάγραμμα Ροής σε Αλγόριθμο / `ΑΝ` & `ΜΕΧΡΙΣ_ΟΤΟΥ`
- [2015 / Θέμα Β1.α][themata_2015] ([Λύσεις][lyseis_2015])
...
> - **Οι πίνακες απαιτούν μνήμη**
    - Κάθε πίνακας δεσμεύει από την αρχή του προγράμματος πολλές θέσεις μνήμης. Σε ένα μεγάλο και σύνθετο πρόγραμμα η άσκοπη χρήση μεγάλων πινάκων μπορεί να οδηγήσει ακόμη και σε αδυναμία εκτέλεσης του προγράμματος. Οι πίνακες περιορίζουν τις δυνατότητες του
...
.footnote[
  Βιβλίο Μαθητή, &sect;9.2, σελ.160
]
...
- Αναζήτηση ενός στοιχείου του πίνακα
    ...
    - Δυαδική αναζήτηση
        ...
        - Σαφώς πιο αποδοτική
--
- Συγχώνευση 2 πινάκων <sup>1</sup>
...
θέση <- 0
*i <- 1
*ΟΣΟ i <= N ΚΑΙ (βρέθηκε = ΨΕΥΔΗΣ) ΕΠΑΝΑΛΑΒΕ !βρέθηκε = ΨΕΥΔΗΣ <=> ΟΧΙ βρέθηκε
  ΑΝ Πίνακας[i] = key ΤΟΤΕ                  !όπου key το στοιχείο που αναζητούμε
    βρέθηκε <- ΑΛΗΘΗΣ
    θέση <- i
* ΑΛΛΙΩΣ
...
ΟΣΟ left <= right ΚΑΙ (βρέθηκε = ΨΕΥΔΗΣ) ΕΠΑΝΑΛΑΒΕ !βρέθηκε = ΨΕΥΔΗΣ <=> ΟΧΙ βρέθηκε
...
.footnote[
  Οδηγίες Διδασκαλίας (163578/Δ2/02-10-2017), σελ.14-15
]
...
> Η προηγούμενη συνάρτηση διάταξης μπορεί να τροποποιηθεί, ώστε να καλύπτει και την περίπτωση που η ταξινόμηση γίνεται με φθίνουσα τάξη (descending sequence) μεγέθους.
...
i <- 2                                  ! ΑΠΟ 2
ΟΣΟ i <= Ν ΚΑΙ flag = ΑΛΗΘΗΣ ΕΠΑΝΑΛΑΒΕ  ! ΜΕΧΡΙ Ν
  flag <- ΨΕΥΔΗΣ                        ! 2η αρχικοποίηση...
  ΓΙΑ j ΑΠΟ Ν ΜΕΧΡΙ i ΜΕ_ΒΗΜΑ -1        ! Για φθίνουσα: Πίνακας[j-1] < Πίνακας[j]
...
.footnote[
  Παράρτημα Α, Οδηγίες Μελέτης Μαθητή, &sect;4.6.1.1, Περίπτωση 2, σελ.57
]
...
.footnote[
  Tετράδιο μαθητή, &sect;3.3, ΔΤ2, σελ.33
]
...
.footnote[
  Tετράδιο μαθητή, &sect;3.3, ΔΣ3, σελ.34
]
...
- Εύρεση Ν ελάχιστων/μέγιστων
    - Χωρίς ταξινόμηση
        - Σε μία επανάληψη <sup>1</sup>
        - Με Ν επαναλήψεις
    - Με "Παράλληλη" ταξινόμηση

.footnote[
  Tετράδιο μαθητή, &sect;4.2, Παράδειγμα 3, σελ.39
]
---
name: 9_3
layout: true
...
.footnote[
    Βιβλίο μαθητή, Παράδειγμα 2, &sect;3.3, σελ.59
]
...
min <- Π[1,1]
max <- Π[1,1]
ΓΙΑ i ΑΠΟ 1 ΜΕΧΡΙ Ν             ! ΠΡΟΣΟΧΗ: όχι απο 2
    ΓΙΑ j ΑΠΟ 1 ΜΕΧΡΙ Μ         ! ΠΡΟΣΟΧΗ: όχι απο 2
        ΑΝ Π[i,j] < min ΤΟΤΕ
            min <- Π[i,j]
        ΤΕΛΟΣ_ΑΝ
        ΑΝ Π[i,j] > max ΤΟΤΕ
...
ΓΙΑ i ΑΠΟ 1 ΜΕΧΡΙ Ν             ! i <-> γραμμές
    ...
    ΓΙΑ j ΑΠΟ 1 ΜΕΧΡΙ Μ         ! j <-> στήλες
        ΑΝ Π[i,j] = key ΤΟΤΕ
            βρέθηκε[i] <- ΑΛΗΘΗΣ
            θέση[i] <- j        ! Σε ποιά στήλη `j` βρέθηκε για τη γραμμή `i`
        ΤΕΛΟΣ_ΑΝ
    ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ
ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ
```
...
ΓΙΑ j ΑΠΟ 1 ΜΕΧΡΙ Μ             ! j <-> στήλες
    ...
    ΓΙΑ i ΑΠΟ 1 ΜΕΧΡΙ Ν         ! i <-> γραμμές
        ΑΝ Π[i,j] = key ΤΟΤΕ
            βρέθηκε[j] <- ΑΛΗΘΗΣ
            θέση[j] <- i        ! Σε ποιά γραμμή `i` βρέθηκε για τη στήλη `j`
        ΤΕΛΟΣ_ΑΝ
    ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ
ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ
```
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.1, σελ.171
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.1, σελ.172
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.2, σελ.1731
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.3, σελ.174
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.4, σελ.175
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5, σελ.175
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5.1, σελ.177-178
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5.1, σελ.176,178
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5.2, σελ.178
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5.3, σελ.181
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5.3, σελ.181-182
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.5.3, σελ.182
]
...
.footnote[
  Βιβλίο Μαθητή, &sect;10.6, σελ.183
]
...
[themata_ps_2016]: https://aepp.edu.gr/files/aepp_2016_imerisia_palaio.pdf
[lyseis_ps_2016]:  https://aepp.edu.gr/files/lyseis_aepp_2016_palaio.pdf

[themata_ns_2016]: https://aepp.edu.gr/files/aepp_2016_imerisia_neo.pdf
